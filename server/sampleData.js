// Pre-engineered Accessible Curriculum Data for SIH InclusiveAI Prototype
export const sampleLessons = [
  {
    ...
    bviModule: {
      ...
      hapticDiagram: {
        ...
        // Vector paths that represent the physical outlines
        paths: [
          {
            id: "outer-wall",
        ...
        // Interactive Landmark POIs (Points of Interest)
        landmarks: [
          {
          ...
          },
          {
            ...
            y: 90,
            radius: 45,
            audioDescription: "You are touching the Aorta. It is the main artery carrying oxygenated blood from the heart to the body.",
...
// Active Student Data for Analytics
export const sampleStudents = [
  {
    ...
    recentSignSubmissions: [
      { word: "Heart", score: 96, timestamp: "2026-08-21T09:12:00Z", status: "Mastered" },
      { word: "Pump", score: 91, timestamp: "2026-08-21T09:14:00Z", status: "Mastered" },
      { word: "Science", score: 92, timestamp: "2026-08-20T14:30:00Z", status: "Mastered" }
    ],
    messagesToTeacher: [
      { id: "msg-1", text: "Completed the Heart circulation sign practice.", timestamp: "2026-08-21T09:16:00Z" }
    ]
  },
  {
    id: "student-ananya",
    ...
    recentQuizResults: [
      ...
      { lesson: "Photosynthesis", score: 19, maxScore: 20, feedback: "Accurate recall of Carbon Dioxide and stomata mechanisms." }
    ],
